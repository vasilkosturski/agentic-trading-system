...
public class AccountPortfolioSnapshot {
    ...
    public AccountPortfolioSnapshot(
            TradingAccount account, Instant timestamp, Double totalValue, Double cashBalance, Double holdingsValue) {
    ...
    public AccountPortfolioSnapshot(TradingAccount account, Instant timestamp, Double totalValue, String snapshotType) {
        this.account = account;
        this.timestamp = timestamp;
        this.totalValue = totalValue;
